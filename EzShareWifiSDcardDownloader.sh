...
# Copied with minor modifications from https://github.com/Biorn1950/EzShare-SdcardWifi-Downloader

# make for the EzShare SD card wifi / microSD white
# Not sure if compatible with all versions
# The webinterface could different and then have to modify the getLine function
...
mainDir="${mainDir:-ezshare-data}"

# Ez Share top Url, top directory, first folder and subfolders
mainUrl="${mainUrl:-http://192.168.4.1}"
remoteDir=("dir=A:")
...
pDl="${parallelDownloads:-16}"

# Use this program as a blacklist or a whitelist, as you prefer.  Blacklist will be prefered if provided.
# Set whiteList to ".log|.crc|.tgt|.dat|.edf|DATALOG|SETTINGS}" for resmed sleep data
whiteList="${whiteList:-}"
